package com.example.kmp.myapplication.adapter

import android.graphics.Typeface
import com.tencent.kuikly.core.render.android.adapter.IKRFontAdapter
import com.example.kmp.myapplication.KRApplication
...
object KRFontAdapter : IKRFontAdapter {
    ...
    override fun getTypeface(fontFamily: String, result: (Typeface?) -> Unit) {
        if (fontFamily.isEmpty()) {
            ...
            when (fontFamily) {
                "Qvideo Digit" -> {
                    tfe = Typeface.createFromAsset(KRApplication.application.assets,
